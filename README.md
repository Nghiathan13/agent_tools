...
- [Youtube](youtube/transcript/README.md): lấy lời bài hát + transcript từ video YouTube qua URL — pipeline build_lyrics (URL → filter ♪ → merge → metadata title/author/duration), helper thư viện thuần (fetch_transcript, find_word, separate_vocals), tool audio CLI (fetch_audio, trim_audio).
